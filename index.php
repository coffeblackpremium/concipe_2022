...
<html lang="en">
  <head>
    <title>CONCIPE 2022 | FASIPE CUIABÁ</title>
    <meta charset="utf-8">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">CONCIPE<span>2022</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="about.html" class="nav-link">O Evento</a></li>
	          <li class="nav-item"><a href="speakers.html" class="nav-link">Submissão</a></li>
	          <li class="nav-item"><a href="schedule.html" class="nav-link">Programação</a></li>
	          <li class="nav-item"><a href="contact.html" class="nav-link">Organização</a></li>
	          <li class="nav-item cta mr-md-2"><a href="#" class="nav-link">Inscrição</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-10 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span>CONCIPE 2022</span></h1>
            <p class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">26-28 outubro, 2022. Cuiabá - MT</p>
...
-->
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |Curso de Analise e Desenvolvimento de Sistema - Fasipe Cuiabá.
